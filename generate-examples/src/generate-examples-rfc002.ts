...
let preimage = jose.util.base64url.encode(Buffer.from(JSON.stringify(JSON.parse(revokedFhirBundle)), 'utf-8'));
...
preimage = jose.util.base64url.encode(Buffer.from(JSON.stringify(JSON.parse(revokedPatient)), 'utf-8'));
